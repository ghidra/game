game.archetypes.item.berries=function(prob){
	return this.init(prob);
}
game.archetypes.item.berries.prototype=new game.archetypes.object();
game.archetypes.item.berries.prototype.constructor=game.archetypes.object;

game.archetypes.item.berries.prototype.init = function(prob){
	...
	this.count = (prob)?prob:1;

	return this;
};
game.archetypes.item.berries.prototype.adjust_pawn_attributes=function(pawn){
...
game.archetypes.item.berries.prototype.get_random_name = function(){
	return 'money';
}