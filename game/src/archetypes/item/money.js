game.archetypes.item.money=function(){
	return this.init();
}
game.archetypes.item.money.prototype=new game.archetypes.object();
game.archetypes.item.money.prototype.constructor=game.archetypes.object;

game.archetypes.item.money.prototype.init = function(){
	game.archetypes.object.prototype.init.call(this,'money');
...
game.archetypes.item.money.prototype.adjust_pawn_attributes=function(pawn){
...
game.archetypes.item.money.prototype.get_random_name = function(){
	return 'money';
}