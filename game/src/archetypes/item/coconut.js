game.archetypes.item.coconut=function(){
	return this.init();
}
game.archetypes.item.coconut.prototype=new game.archetypes.object();
game.archetypes.item.coconut.prototype.constructor=game.archetypes.object;

game.archetypes.item.coconut.prototype.init = function(){
...
game.archetypes.item.coconut.prototype.adjust_pawn_attributes=function(pawn){
...
game.archetypes.item.coconut.prototype.get_random_name = function(){
	return 'money';
}