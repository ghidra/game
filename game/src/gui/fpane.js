...
game.dom.fpane=function(id,label,style,hide){
	return this.make(id,label,style,hide);
}
game.dom.fpane.prototype=new game.dom.pane();
game.dom.fpane.prototype.constructor=game.dom.pane;

game.dom.fpane.prototype.make=function(id,label,styles,hide){
...
//---------------------------
game.dom.fpane.prototype.make_entry=function(id,label,styles){
